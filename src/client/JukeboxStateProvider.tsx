...
import type { TrackMetadata, PlayerState, SpotifyIdWithArtwork, HotkeyConfig } from '../types';

// Re-export types for convenience
export type { TrackMetadata, PlayerState, SpotifyIdWithArtwork, HotkeyConfig };
